      ...
      <div className="flex items-center justify-between max-w-7xl mx-auto px-6 py-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <nav className="hidden lg:flex items-center gap-6 ml-10">
            <Link
              to="/dashboard"
              className="text-sm font-semibold text-gray-700 hover:text-eco-main"
            >
              Dashboard
            </Link>
            ...
            {/* <Link
              to="/community/create-request"
              className="px-4 py-2 bg-eco-main text-white rounded-lg text-sm font-semibold hover:bg-green-700"
            >
              + Create Request
            </Link> */}
          </nav>
