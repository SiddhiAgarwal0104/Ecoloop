          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <select
                  value={formData.role}
                  onChange={e => { setFormData(p => ({ ...p, role: e.target.value })); clearMessages(); }}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-eco-main focus:border-transparent outline-none transition text-gray-700 bg-white"
                >
