            ...
            {['Details', 'Verify Email', 'Done'].map((label, i) => {
              ...
              return (
                <div key={label} className="flex items-center gap-2">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all ${isDone ? 'bg-green-500 text-white' : isActive ? 'bg-eco-main text-white' : 'bg-gray-200 text-gray-500'
                    }`}>
                    {isDone ? '✓' : stepNum}
                  </div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {[
                    ...
                    <button
                      ...
                      className={`p-4 rounded-xl border-2 transition-all ${formData.role === role ? 'border-green-500 bg-green-50' : 'border-gray-200 hover:border-green-300'
                        }`}
                    >
